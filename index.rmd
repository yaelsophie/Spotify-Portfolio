...
Image See the image I included in my GitHub for an overall score of speechiness per album. The albums Wave and Close to Paradise have similar scores of speechiness that are close together, they don't differentiate a lot. While other albums differentiate a lot from speechiness within the album itself.
Aantekeningen voor mijzelf paar nummers uitkiezen die inderdaad in eerdere albums voorkwamen als hoog pitched, en een paar die dat toentertijd al niet waren stijl ontdekken van patrick watson -> chamber music is dit over de loop van de tijd veranderd?
zoeken naar nummers van vroegere albums die erg lijken op nummers van recentelijke albums andere zoeken die totaal verschillen
